...
public class StockFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final TextView param1 = (TextView)view.findViewById(R.id.param1);
        param1.setText(ARG_PARAM1 + "=" + mParam1);

        final TextView param2 = (TextView)view.findViewById(R.id.param2);
        param2.setText(ARG_PARAM2 + "=" + mParam2);

        Button button = (Button) view.findViewById(R.id.fragment_button);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                onButtonPressed(param1.getText() + ", " + param2.getText());
            }
        });

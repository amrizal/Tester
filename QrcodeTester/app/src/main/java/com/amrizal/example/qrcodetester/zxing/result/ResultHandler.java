...
package com.amrizal.example.qrcodetester.zxing.result;
...
import com.amrizal.example.qrcodetester.zxing.Contents;
import com.amrizal.example.qrcodetester.zxing.Intents;
import com.amrizal.example.qrcodetester.zxing.Intents.SearchBookContents;
import com.amrizal.example.qrcodetester.zxing.LocaleManager;
import com.amrizal.example.qrcodetester.zxing.PreferencesActivity;
 ...
 * 
 * This class also contains a bunch of utility methods to take common actions like opening a URL. They could easily be moved into a helper object, but it can't be static because the Activity instance
 * is needed to launch an intent.
 * 
...
public abstract class ResultHandler {
    ...
    private static final int[] PHONE_TYPE_VALUES = { ContactsContract.CommonDataKinds.Phone.TYPE_HOME, ContactsContract.CommonDataKinds.Phone.TYPE_WORK,
            ContactsContract.CommonDataKinds.Phone.TYPE_MOBILE, ContactsContract.CommonDataKinds.Phone.TYPE_FAX_WORK, ContactsContract.CommonDataKinds.Phone.TYPE_PAGER,
    ...
    final void addContact(String[] names, String[] nicknames, String pronunciation, String[] phoneNumbers, String[] phoneTypes, String[] emails, String[] emailTypes, String note,
            String instantMessenger, String address, String addressType, String org, String title, String[] urls, String birthday, String[] geo) {

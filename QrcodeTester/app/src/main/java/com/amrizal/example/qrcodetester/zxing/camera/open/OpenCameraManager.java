...
package com.amrizal.example.qrcodetester.zxing.camera.open;
...
public final class OpenCameraManager extends PlatformSupportManager<OpenCameraInterface> {
	...
	addImplementationClass(9, "com.amrizal.example.qrcodetester.zxing.camera.open.GingerbreadOpenCameraInterface");
    }

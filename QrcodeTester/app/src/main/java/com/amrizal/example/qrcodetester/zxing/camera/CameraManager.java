...
package com.amrizal.example.qrcodetester.zxing.camera;

import java.io.IOException;

import com.amrizal.example.qrcodetester.zxing.camera.open.OpenCameraManager;
...
public final class CameraManager {
    ...
    public synchronized void startPreview() {
        Log.d(TAG, "running startPreview()...");
        Camera theCamera = camera;
    ...
    public synchronized Rect getFramingRect() {
        if (framingRect == null) {
            ...
            // elock - for portrait only purpose
            // int width = screenResolution.x * 3 / 4;

            int width = screenResolution.x * 10 / 10;
            ...
            Log.d(TAG, "screenResolution y = " + screenResolution.y);
    ...
    public synchronized Rect getFramingRectInPreview() {
        if (framingRectInPreview == null) {
            ...
            /*
             * rect.left = rect.left * cameraResolution.x / screenResolution.x; rect.right = rect.right * cameraResolution.x / screenResolution.x; rect.top = rect.top * cameraResolution.y /
             * screenResolution.y; rect.bottom = rect.bottom * cameraResolution.y / screenResolution.y;
             */

...
final class CameraConfigurationManager {
    ...
    private static final int MAX_PREVIEW_PIXELS = 1280 * 800;// 1920 * 1080;//
	...
	/*
	 * elock - for portrait only purpose if (width < height) { Log.i(TAG, "Display reports portrait orientation; assuming this is incorrect"); int temp = width; width = height; height = temp; }
	 */
	...
	camera.setDisplayOrientation(90); // elock - for portrait only purpose
	...
	for (Camera.Size supportedPreviewSize : supportedPreviewSizes) {
	    ...
	    // elock - for portrait only purpose float newDiff = Math.abs(aspectRatio - screenAspectRatio);
	    if (newDiff < diff) {
